...
router.get("/", checkWebOnly, checkRole([USER_ROLES.ADMIN]), getTimetables);

// get a specific timetable with all its entries populated
router.get("/:id", checkWebOnly, checkRole([USER_ROLES.ADMIN]), validate(timetableIdParamsSchema), getTimetableById);
