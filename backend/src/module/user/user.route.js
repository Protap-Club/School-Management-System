...
import { createUser, getUsers, toggleUserStatus, uploadAvatar } from "./user.controller.js";
...
router.delete("/", checkWebOnly,checkRole([USER_ROLES.ADMIN]), validate(userIdsBodySchema));
