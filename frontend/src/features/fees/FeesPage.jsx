...
import {
    FaPlus, FaEdit, FaTrash, FaTrashAlt, FaTimes, FaCheck, FaMoneyBillWave,
    FaChartBar, FaListAlt, FaFilter, FaArrowLeft, FaArrowRight, FaReceipt, FaHistory,
    FaWallet, FaSearch, FaUser, FaCalendarAlt
} from 'react-icons/fa';
