...
import { FaTimes, FaUserGraduate, FaIdCard, FaBuilding, FaLayerGroup } from 'react-icons/fa';

/**
 * Modal to display student details and attendance history
 */
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="p-6 grid grid-cols-2 lg:grid-cols-4 gap-4 bg-gray-50 border-b border-gray-100 shrink-0">
          <div className="p-3 bg-white rounded-xl border border-gray-100 shadow-sm">
            ...
            <p className="text-lg font-semibold text-gray-800">{student.profile?.rollNumber || '-'}</p>
          </div>
          <div className="p-3 bg-white rounded-xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-2 text-gray-500 text-xs uppercase font-bold mb-1">
              <FaBuilding className="text-purple-500" /> Class
            </div>
            <p className="text-lg font-semibold text-gray-800">{student.profile?.standard || '-'}</p>
          </div>
          <div className="p-3 bg-white rounded-xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-2 text-gray-500 text-xs uppercase font-bold mb-1">
              <FaLayerGroup className="text-orange-500" /> Section
            </div>
            <p className="text-lg font-semibold text-gray-800">{student.profile?.section || '-'}</p>
          </div>
          <div className="p-3 bg-white rounded-xl border border-gray-100 shadow-sm">
            <div className="flex items-center gap-2 text-gray-500 text-xs uppercase font-bold mb-1">
              <FaUserGraduate className="text-emerald-500" /> Status
            </div>
        ...
        <div className="p-6 overflow-y-auto">
          <h3 className="text-lg font-bold text-gray-800 mb-4">Attendance History (Last 30 Days)</h3>
